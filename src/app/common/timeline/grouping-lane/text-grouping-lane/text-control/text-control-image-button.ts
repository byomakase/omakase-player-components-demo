...
export class TextControlImageButton implements TextControl {
  private _config: TextControlConfig;
  private _button: ImageButton;
  private _state: TextControlState;

  constructor(config: TextControlConfig) {
    this._config = config;
  ...
  set state(value: TextControlState) {
    this._state = value;
