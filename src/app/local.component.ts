...
import {MediaHandlersLayoutComponent} from './components/layouts/media-handlers-layout/media-handlers-layout.component';
...
import {MarkerLayoutComponent} from './components/layouts/marker-layout/marker-layout';
...
const layouts: Record<Layout, Type<any>> = {
  'media-handlers': MediaHandlersLayoutComponent,
